...
class EditProfilePage extends GetView<EditProfileController> {
  ...
  Widget build(BuildContext context) => PopScope(
        ...
        onPopInvoked: (didPop) {
          ...
          controller.profileController.loadUserFromServer();
        },
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: Obx(
              () => controller.isLoadingSaveData.value
                  ? const Center(
                      // heightFactor: 12,
